package Java_basics.codes.OOPs.Polymorphism;

public class polymorphism {
    public static void main(String[] args) {
//        compile time polymorphism is basically method overloading
//        run-time polymorphism is basically method overriding
    }
}
