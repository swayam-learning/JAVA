...
public class Final_in_objects {
    public static void main(String[] args) {
        // we cannot change a method if it is final or we cannot inherit from a final class
...
//    For example, a final StringBuffer variable looks
//    defined below as follows:
//
//    final StringBuffer sb;
//
//    As we all know that a final variable cannot be re-assign. But in the case of a reference final variable, the internal state
//    of the object pointed by that reference variable can be changed. Note that this is not re-assigning.
